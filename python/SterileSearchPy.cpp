...
BOOST_PYTHON_MODULE(SterileSearchPy)
{
  ...
  class_<SS::DataPaths, boost::noncopyable,std::shared_ptr<SS::DataPaths> >("DataPaths",init<>())
    ...
    .def_readwrite("use_simple_filename",&SS::DataPaths::use_simple_filename)
  ...
  class_<SS::SteeringParams, boost::noncopyable,std::shared_ptr<SS::SteeringParams> >("SteeringParams",init<>())
    ...
    .def_readwrite("calculate_nusquids_on_the_fly",&SS::SteeringParams::calculate_nusquids_on_the_fly)
    .def_readwrite("use_simplified_simulation",&SS::SteeringParams::use_simplified_simulation)
  ...
  class_<SS::Sterilizer, boost::noncopyable, std::shared_ptr<SS::Sterilizer> >("Sterilizer", init<SS::DataPaths,SS::SteeringParams,SS::SterileNuParams>())
    ...
    .def("WriteCompact",&SS::Sterilizer::WriteCompact)
    .def("WriteFastCompact",&SS::Sterilizer::WriteFastCompact)
    ...
    .def("SetupAsimovForAlternativeHypothesis",(double(SS::Sterilizer::*)(SS::Nuisance,SS::SterileNuParams))&SS::Sterilizer::SetupAsimovForAlternativeHypothesis)
    .def("SetupDataChallenge",(double(SS::Sterilizer::*)(SS::Nuisance,int,SS::SterileNuParams))&SS::Sterilizer::SetupDataChallenge)
